...
int main() {
    ...
    ssd1306_draw_string(ssd, 0, 16, "Aguardando...");
    ssd1306_draw_string(ssd, 0, 32, "Aperte Botao: A");
    ssd1306_draw_string(ssd, 0, 42, "para ativar!");
    render_on_display(ssd, &frame_area);
    ...
    while (true) {
        ...
        if (gpio_get(BUTTON_A_PIN) == 0) {
            ...
            ssd1306_draw_string(ssd, 0, 32, "Aguardando Som ");
            ssd1306_draw_string(ssd, 0, 42, "Aperte Botao: B");
            ssd1306_draw_string(ssd, 0, 52, "para Desativar");
            render_on_display(ssd, &frame_area);
            sleep_ms(200); 
        }
